...
public class BoxMovingOnPlatform : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Physics.CheckBox(checkBoxPosition, boxCollider.bounds.extents, this.transform.rotation, groundLayers, QueryTriggerInteraction.Ignore)) //QueryTriggerInteraction.Ignore
        {
